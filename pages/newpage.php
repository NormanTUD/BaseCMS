...
?>
								...
								<td><?php
									foreach ($rollen as $trow) {
										...
										print "<input $tchecked type='checkbox' value='$rolle_id' name='role_to_page[]' /> $rolle_name<br />";
									}
								?></td>
						...
						<tr>
							...
							<td><?php
								foreach ($rollen as $trow) {
									$rolle_id = $trow[0];
									$rolle_name = $trow[1];
									print "<input type='checkbox' value='$rolle_id' name='role_to_page[]' /> $rolle_name<br />";
								}
							?></td>
