...
?>
		...
		<form method="post" action="<?php $GLOBALS['adminpage']; ?>?page=<?php print $GLOBALS['this_page_number']; ?>">
...
?>
					<tr>
						...
						<td><?php print check_function_rights_role_id($row[1], $row[4], 0) ? '<span style="color: green";>Ja</span>' : '<span style="color: red";>Nein</span>'; ?></td>
					</tr>
<?php
				}
?>
...
?>
					<tr>
						...
						<td><?php print check_page_rights_role_id($row[1], $row[4], 0) ? '<span style="color: green";>Ja</span>' : '<span style="color: red";>Nein</span>'; ?></td>
					</tr>
<?php
				}
?>
